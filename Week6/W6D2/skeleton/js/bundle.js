...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  // <li class="square" data-pos="0,0"></li>

  const $rows = $('ul.group');
  // console.log($rows);
  $rows.each(function () {
    // const $squares = $('li.square');
    const $squares = $(this).children();
    $squares.each(function () {
      // const $colNumber = $('data-pos').split(",")[1];
      const $colNumber = $(this).data("pos").split(",")[1];
...
View.prototype.exercise5 = function () {
  ...
  function alertMessage(pos) {
    alert(`${pos} was clicked!`);
  }
...
View.prototype.exercise7 = function(){
  ...
  $squares.on("mouseover", event => {
    ...
    console.log($currentTarget[0].style.backgroundColor);
  });
};
